        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          {guestSession && (
            <button
              ...
              onClick={() => onNavigate('standings', { tournamentId })}
              style={{ marginTop: '0.25rem', minWidth: '160px', display: 'flex', alignItems: 'center', gap: '0.5rem', justifyContent: 'center', padding: '0.6rem 1.25rem', fontSize: '0.9rem' }}
            >
