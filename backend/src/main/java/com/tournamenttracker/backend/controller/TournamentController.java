...
public class TournamentController {
    ...
    public ResponseEntity<Tournament> createTournament(@RequestBody Tournament tournament) {
        ...
        // Autogenerate URL pointing to the matches page
        String autogeneratedUrl = frontendBaseUrl + "/matches?tournamentId=" + saved.getId();
    ...
    public ResponseEntity<Tournament> updateTournament(@PathVariable Long id, @RequestBody Tournament tournamentDetails) {
        return tournamentRepository.findById(id).map(existingTournament -> {
            ...
            if (existingTournament.getUrl() == null || existingTournament.getUrl().isEmpty()) {
                existingTournament.setUrl(frontendBaseUrl + "/matches?tournamentId=" + id);
            }
